...
| --- | --- |
| [](https://github.com/Mark-MDO47/UniRemote/tree/master/code/WriteRFID "WriteRFID") | Code to write RFID cards based on text strings in same format as input to QRCode.py |
