...
| [code/WriteRFID](https://github.com/Mark-MDO47/UniRemote/tree/master/code/WriteRFID "WriteRFID") | Code works on both UniRemoteCYD hadware and EPS32D special hardware. Used to write RFID cards using input text strings in same format as input to QRCode.py - attributions in the code |
